...
2. query_parameter인 parent_comment_id가 없으면 해당 게시글의 댓글이 조회되고, 댓글 id를 전달하면 해당 댓글의 대댓글을 조회할 수 있다.
...
5. Swagger API 문서로 들어가서 API를 테스트한다.
```bash
